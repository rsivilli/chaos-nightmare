...
class Chatbot(commands.Bot):
    ...
    async def event_join(self, channel: Channel, user: User):
        await channel.send(
            f"Welcome {user.name}! If this is your first time or if it has been a while, you can always use the command !help to get started. Otherwise, just throw things into chat and see what the ai creates!"
        )
